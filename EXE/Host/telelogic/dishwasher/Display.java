...
//!	Generated Date	: Wed, 12, Apr 2023 
	File Path	: EXE/Host/telelogic/dishwasher/Display.java
*********************************************************************/
...
//----------------------------------------------------------------------------
// telelogic/dishwasher/Display.java                                                                  
//----------------------------------------------------------------------------
...
public class Display implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassDisplay = new AnimClass("telelogic.dishwasher.Display",false);
    //#]
    ...
    */
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public int WaitForKeys_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(evKeyPress.evKeyPress_dishwasher_telelogic_id))
                {
