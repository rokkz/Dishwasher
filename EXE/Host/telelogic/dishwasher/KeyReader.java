...
//!	Generated Date	: Wed, 12, Apr 2023 
	File Path	: EXE/Host/telelogic/dishwasher/KeyReader.java
*********************************************************************/
...
//----------------------------------------------------------------------------
// telelogic/dishwasher/KeyReader.java                                                                  
//----------------------------------------------------------------------------
...
public class KeyReader implements RiJActive, RiJStateConcept, Animated {
    ...
    public static AnimClass animClassKeyReader = new AnimClass("telelogic.dishwasher.KeyReader",false);
    //#]
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public void action_1Enter() {
            ...
            if (itsDisplay != null)
            itsDisplay.gen(new evKeyPres(cmd));
            //#]
        }
